...
This project is licensed under the Lumina Permissive License, which is a modified version of the MIT License that requires starring of this GitHub repo if used in a commerical manner.